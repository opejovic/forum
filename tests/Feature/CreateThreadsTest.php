...
class CreateThreadsTest extends TestCase
{
    ...
    /** @test */
    public function guests_cannot_publish_threads()
    {
    ...
    /** @test */
    public function an_authenticated_user_can_publish_new_threads()
    {
    ...
    /** @test */
    public function an_authenticated_user_cannot_delete_other_users_threads()
    {
    ...
    /** @test */
    public function an_authenticated_user_can_delete_their_threads()
    {
        $user = factory(User::class)->create();
        auth()->login($user);
    ...
    /** @test */
    public function when_thread_is_deleted_all_of_the_replies_are_also_deleted()
    {
    ...
    /** @test */
    public function a_thread_title_should_be_atleast_2_characters_long()
    {
    ...
    /** @test */
    public function a_threads_body_should_be_atleast_2_characters_long()
    {
